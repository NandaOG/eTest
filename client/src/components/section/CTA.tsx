        ...
        <div className="flex bg-[url('/backgrounds/grid.svg')] flex-col md:flex-row items-center justify-between w-full border-2 border-white my-10 p-10 rounded-3xl gap-5">
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl md:text-5xl text-white">
              <b>Let&apos;s Connect </b> and Create Your Perfect Style!
            </h2>
          </div>
          <div className="w-full md:w-1/2">
            <p className="text-lg md:text-3xl text-white">
              Need styling advice or have questions? Our fashion experts are here to
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10 text-white rounded-3xl pt-10">
          ...
          <div className="md:w-1/2 flex flex-col gap-4 py-10 bg-[url('/backgrounds/parabolic.svg')]">
            ...
            <div className="space-y-5 text-white">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p>
                    <a
                      href="mailto:hello@luxeapparel.com"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-400">Tax ID: 12-3456789</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.facebook.com/profile.php?id=61575556581825"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-blue-500 transition duration-300 text-2xl border border-white p-2 rounded-full"
              >
                <FaFacebookF />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-blue-400 transition duration-300 text-2xl border border-white p-2 rounded-full"
              >
                <FaTwitter />
              </a>
              <a
                href="https://www.linkedin.com/company/cyberpeak-it-solutions-pvt-ltd"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-blue-600 transition duration-300 text-2xl border border-white p-2 rounded-full"
              >
                <FaLinkedinIn />
              </a>
              <a
                href="https://www.instagram.com/cyberpeakitsoulutions/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-pink-500 transition duration-300 text-2xl border border-white p-2 rounded-full"
              >
                <FaInstagram />
              </a>
            </div>
